...
<div id="wrapper">
	...
	<div class="container">
		...
		<div id="myContent" style="text-align:center;">
			<form action="get_data_receiver.php" name='form' method="GET">
				<p align="center">Inserisci il tuo username</p> <input type='text' name='username' value=''/><br/><br/>
				<p align="center">Inserisci la tua password</p> <input type='password' name='password' value=''/><br/><br/>
