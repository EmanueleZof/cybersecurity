		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					...
					<li class="active">Test $_SERVER</li>
				</ul>
			</div>
		</div>
	</div>
		...
		<ul>
			<?php
				foreach($_SERVER as $key => $info) {
					$e = array('SERVER_NAME','SERVER_SOFTWARE','SERVER_PORT','REQUEST_SCHEME','HTTP_USER_AGENT');
					if (in_array($key, $e)) {
						echo "<li><b>".$key.":</b> ".$info."</li>";
					}
				}
			?>
		</ul>
		<?php echo '<a href="'.DB_LECTURES_FOLDER.'lect-2/lect2.php" class="btn btn-theme">Torna a esercitazione 2</a>'; ?>	
	</div> <!-- /.container -->
	</section>
	<!-- CONTENT end -->
	<!-- %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% -->
